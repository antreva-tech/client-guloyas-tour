# Guloyas Tours — Client Information
...
Use these values when configuring `.env` for Guloyas Tours:
...
- **RNC** (Registro Nacional del Contribuyente): Dominican tax ID — use on invoices, legal footer, or official documents when required.
- WhatsApp numbers: strip spaces, parentheses, and dashes for `NEXT_PUBLIC_WHATSAPP_NUMBER` (e.g., `18297188926`).
